...
- [Preventative Controls](#preventative-controls)
  ...
  - [2. AKS Data is protected using a CG Managed Key](#2-AKS-Data-is-protected-using-a-CG-Managed-Key)
  - [3. AKS enforces least privilege for access to API server & nodes](#3-AKS-enforces-least-privilege-for-access-to-API-server--nodes)
  ...
  - [5. AKS connections are protected with TLS 1.2](#5-ASL-connections-are-protected-with-TLS-12)
