...
# (ROUGH DRAFT) AWS MWAA (Managed Workflows for Apache Airflow) - Security Playbook <!-- omit in toc -->
## Capgroup Cybersecurity Control Alignment <!-- omit in toc -->

This is a MVP Security Runbook to allow PoC of Managed Workflows for Apache Airflow.  In order to use this service in production, the rest of the runbook will have to be filled with additional cloud security requirements. 
...
[<INSERT Reviewer Name> (Initials)](https://cgweb3/profile/<Insert Reviewer Initials>)
<br>
