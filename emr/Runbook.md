...
**How** Refer to Internal Documentation on how to install the Qualys Agent (Capital Group's vulnerability management software)[5]. If you are deploying an EC2 instance from an image that does not already have this software installed and configured, you will need to include it in the initial deployment.
