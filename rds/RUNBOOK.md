...
# Amazon Relational Database Service (RDS) - Security Playbook <!-- omit in toc -->
...
## Overview
AWS provides a number of security features for Amazon Relational Database Service (RDS) which help you comply with the NIST Cybersecurity Framework. The following playbook will outline what the AWS best practices are, how they align to NIST, and how to implement these best practices within your organization.
