...
**NOTE:** `GuardDuty is an AWS Managed service offering, the underlying Infrastructure including Network and Compute resources are all managed by AWS as explained in the Shared Responsibility Model. Due to this fact, CG's standard public access controls cannot be applied and the controls to keep the service from external or public accessibility falls on AWS.` 